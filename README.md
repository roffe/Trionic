...
## System Requirements
- A PC running Windows 7, Windows 8.1, Windows 10, Windows 11.
- <strong>Windows XP and Windows Vista is NOT supported anymore.</strong>
- Microsoft .NET 4.8
- Microsoft Visual C++ 2010 Redistributable Package (x86)

Download zip from releases and extract TrionicCANFlasher.msi.
...
The first step is to download the latest version of the Trionic CAN Flasher. When downloaded, you should have the TrionicCANFlasher.msi file. Run the TrionicCANFlasher.msi to install Trionic CAN Flasher.
